...
public class UColorTool {
  ...
  public static final int avg(String col1,String col2) {
  	return interpolate(0.5f, toColor(col1), toColor(col2));
  }

  public static final int avg(int col1,int col2) {
  	return interpolate(0.5f, col1, col2);
  }
