...
public class Triangulate {
  ...
  */
   ...
   */
  public static Vec3 [] triangulate(Vec3 v[]) {
  	Vec3 tri[]=null;
  	...
  	if(triArr.size()>0) {
    	tri=new Vec3[triArr.size()*3];
      Iterator pIter = triArr.iterator();
      
      int id=0;
      while (pIter.hasNext()) {
      	Triangle t = (Triangle)pIter.next();
      	tri[id++]=new Vec3(t.p1.x,t.p1.y,t.p1.z);
      	tri[id++]=new Vec3(t.p2.x,t.p2.y,t.p2.z);
      	tri[id++]=new Vec3(t.p3.x,t.p3.y,t.p3.z);
      }
  	}
  	return tri;
  }
